...
public class EditorActivity extends AppCompatActivity {
    ...
    public void insertPet(){
        ...
        pet.put(PetEntry.COLUMN_PET_NAME, nameString);
        pet.put(PetEntry.COLUMN_PET_BREED, breedString);
        pet.put(PetEntry.COLUMN_PET_GENDER, mGender);
        pet.put(PetEntry.COLUMN_PET_WEIGHT, weightInt);
